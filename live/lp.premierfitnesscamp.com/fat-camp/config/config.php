...
const CONFIG = [
    ...
    */
    ...
    'site_title' => 'Premier Fat Camp',
    'tag_line' => '',
    'phone' => '(888)488-8936',
    'site_url' => 'https://www.premierfitnesscamp.com/lp/fat-camp', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

    'site_email' => 'info@premierfitnesscamp.com', // Leave Blank or comment for no email in footer
    ...
    */
    'to' => [
        //'info@premierfitnesscamp.com' => 'Premier Fitness Camp'
		'frontend@smartsites.com' => 'FED SmartSites'
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'smtp' => [
        ...
        'smtp_email' => 'leadpremierfitnesscamp@gmail.com',
        'smtp_password' => 'exooppyndgcokgmy',
...
function successMessage()
{
    ...
    return "<div class='thank-you-message'><p class='thank-you-heading'>Thank you for your message, we will be in touch shortly. </p>" .
        "<p class='thank-you-content'>If you would like to speak with someone sooner, please call <a href='tel:" . $tel . "'>" . $phone . " </a>.</p>";
}
