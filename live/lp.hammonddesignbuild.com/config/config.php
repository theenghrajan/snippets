...
const CONFIG = [
  ...
  'site_title' => 'Hammond Design Build',
  'tag_line' => '',
  'phone' => '503-826-4383',
  'site_url' => 'https://lp.hammonddesignbuild.com', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

  'site_email' => 'todd@hammonddb.com', // Leave Blank or comment for no email in footer
  //'link_facebook' => 'https://www.facebook.com/HammondDesignBuild', // Leave Blank or comment for no icon and no link
  //'link_instagram' => 'https://www.instagram.com/hdesignbuild/', // Leave Blank or comment for no icon and no link
  ...
  'to' => [
    //'frontend@smartsites.com' => 'FED SmartSites'
    'todd@hammonddb.com' => 'Todd Hammond'
  ],
  /*
    |--------------------------------------------------------------------------
