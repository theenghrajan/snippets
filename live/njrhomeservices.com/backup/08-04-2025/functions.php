...
function njr_home_service_scripts()
{
	...
	if (is_page_template(['lp/tpl-spring-install-lp.php', 'lp/tpl-winter-install-special-lp.php', 'lp/win2025/tpl-win2025-lp.php'])) {
...
{
	if (is_page_template(['lp/tpl-winter-install-special-lp.php', 'lp/win2025/tpl-win2025-lp.php'])) {
