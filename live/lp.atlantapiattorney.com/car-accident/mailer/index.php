...
// CORS FIX: Added by FED(RT) on 07-11-25
...
// 3. Referrer Check
$allowedReferrer = 'https://lp.atlantapiattorney.com/car-accident'; // Replace with your landing page URL (no trailing slash)
...
if (!empty($_POST)) {
    ...
    */
    ...
    $data = [
        ...
        'website' => "https://lp.atlantapiattorney.com/car-accident/"
    ];
