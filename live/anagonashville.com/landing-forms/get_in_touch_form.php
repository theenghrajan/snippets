<form method="POST" action="mailer/index.php" id="form-id-1" class="validate form">
	<div class="form-section-0 flex flex-wrap -mx-2">
		...
		<div class="form-group">
			<select class="form-control" name="choose-your-service" id="On5YQ">
				...
				<option value="Option One">Weekly Recurring Service</option>
			</select>
		...
		<div class="form-group !w-full">
			<textarea class="form-control" placeholder="Message" name="message" cols="" rows=""></textarea>
			<div class="messages"></div>
		</div>
	...
	<div class="form-footer">
		<button type="submit" class="submitButton btn btn-form w-full relative">
