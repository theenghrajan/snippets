                            ...
                            <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                    <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                                        Thank you for downloading our ebook, Overcoming MCA Debt! We hope you find the insights and strategies valuable for relieving your MCA debt and achieving your business goals.
                                        <br><br>
                                        Our team is dedicated to supporting you on this journey. One of our experts will be in touch with you shortly to offer further assistance and answer any questions you may have.
                                        <br><br>
                                        In the meantime, if you need immediate support, call us at <strong><?php echo CONFIG['phone'];?></strong>
                                        <br><br>
