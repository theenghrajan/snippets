                ...
                <div style="background-color: transparent; width: 100% !important;">
                    ...
                    <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                            ...
                            <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                    <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                                        Thank you for requesting our ebook, Overcoming MCA Debt! We hope you find the insights and strategies valuable for relieving your MCA debt and achieving your business goals. <br>
                                        In the meantime, if you need immediate support, call us at <strong><?php echo CONFIG['phone'];?></strong> <br>
                                        Thank you once again for your interest. <br>
                                        If you don't see your ebook in your inbox within 5-10 minutes, please check your spam or junk folder.
                                    </p>
                                </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div align="center" class="button-container center "
                            ...
                            <a href="https://valuecapitalfunding.com/mca-debt-restructuring/" title="<?php echo CONFIG['site_title']?>" style="text-decoration: none;color: white">
                                <!--[if mso]>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0"
