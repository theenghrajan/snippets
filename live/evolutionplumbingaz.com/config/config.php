...
const CONFIG = [
    ...
    */
    ...
    'site_title' => 'Evolution Plumbing AZ',
    'tag_line' => '',
    'phone' => '480-662-6555',
    'site_url' => '', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

    'site_email' => 'evlplumbing@gmail.com', // Leave Blank or comment for no email in footer
    ...
    */
    'to' => [
        'evlplumbing@gmail.com' => 'Evolution Plumbing AZ'
    ...
    */
    'smtp' => [
        'smtp_email' => 'evlplumbing@gmail.com',
        'smtp_password' => 'evanbabaigevdagm',
...
function successMessage()
{
    ...
    return "<div class='thank-you-message'><p class='thank-you-heading'>Thank you for your message, we will be in touch shortly.</p>" .
        "<p class='thank-you-content'>If you would like to speak with someone sooner, please call " . "<a href='tel:" . $tel . "'>" . $phone . " </a>.</p></div>";
}
