    ...
    <div class="scoring-template awd-template">
    	<div class="wrap">
    		<div class="awd-wrap">
				...
				<?php endif; ?>
				<div class="scoring-title-area">
				<?php if(get_field('scoring_sec_title')) : ?><h1 class="section-title"><span><?php echo get_field('scoring_sec_title'); ?></span></h1><?php endif; ?>
	    		...
	    		<div class="two-thirds first">
			        ...
			        <?php if(get_field('score_feedback_title')) : ?>
			        	<div class="feedback-title"><h3 class="text-center"><?php echo get_field('score_feedback_title'); ?></h3></div>
			        <?php endif; ?>						
	                <?php if( have_rows('score_feedback_items') ): $count = 1; while( have_rows('score_feedback_items')): the_row();?>
						<?php
			                    ...
			                    <div class="service-btn">
									...
									<?php else : ?>
			                    		<a href="#" class="add-to-shopify-cart"
			                    			...
			                    			data-shopify="<?=$service_shopify_product?>" 
			                    		>Buy now</a>
									<?php endif; ?>
			                    </div>
