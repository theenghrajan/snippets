...
const CONFIG = [
    ...
    */
    ...
    'site_title' => 'Serene Comfort',
    'tag_line' => '',
    'phone' => '(248) 765-1714',
    'site_url' => 'https://serenecomfort.net/lp', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

    'site_email' => 'service@serenecomfort.net', // Leave Blank or comment for no email in footer
    ...
    */
    'to' => [
        'ivan@serenecomfort.net' => 'Serene Comfort'
    ...
    */
    'smtp' => [
        'smtp_email' => 'serenecomfortmichigan@gmail.com',
        'smtp_password' => 'bkutdmzpurzfcqwh',
...
function successMessage()
{
    ...
    return "<div class='thank-you-message'><p class='thank-you-heading'>Thank you for your message, we will be in touch shortly.</p>" .
        "<p class='thank-you-content'>If you would like to speak with someone sooner, please call " .
        "<a href='tel:" . $tel . "'>" . $phone . " </a></p></div>";
}
