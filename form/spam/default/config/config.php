...
const CONFIG = [
    ...
    */
    ...
    'site_title' => 'Premier Casting Solutions',
    'tag_line' => '',
    'phone' => '(631) 513-3094',
    'site_url' => 'premiercastingsolutions.com', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

    'site_email' => 'info@premiercastingsolutions.com', // Leave Blank or comment for no email in footer
    ...
    */
    'to' => [
        'info@premiercastingsolutions.com' => 'Premier Casting Solutions'
        // 'frontend@smartsites.com' => 'SmartSites'
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'cc' => [
        'tyler@premiercastingsolutions.com' => 'Premier Casting Solutions',
        'michaela@smartsites.com' => 'SmartSites',
    ],
        /*
    |--------------------------------------------------------------------------
    ...
    */
    'smtp' => [
        'smtp_email' => 'premiercastinglp@gmail.com',
        'smtp_password' => 'ickxbkkafzjenkjj',
...
function successMessage()
{
    ...
    return "<div class='thank-you-message'><p class='thank-you-heading'> Thank you for your message.</p>" .
        "<p class='thank-you-content'>We will be in touch shortly. If you would like to speak with someone sooner, please call " .
