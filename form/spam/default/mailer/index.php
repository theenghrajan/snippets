 ...
 * Time: 10:06
 */
// Start session: Added by FED(GS) on 6th February 2025
session_start();
...
// 3. Referrer Check -----------------------------------------------
$allowedReferrer = 'https://lp.premiercastingsolutions.com';// Replace with the LP URL without the trailing slash
...
$secretKey = '6LfVhswqAAAAALt-wHRRBn2n0gOjmSwO37sINqNS'; // Replace with the Google Re-Captcha Secret Key for the project
