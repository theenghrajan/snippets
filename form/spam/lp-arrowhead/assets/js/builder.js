var $recaptchaV2SiteKey = '6LdNqc0qAAAAAGDBo9baYyRj0mrrpzlL1Jm0hnSP';
    ...
    function showSuccess(form) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $(form).html(data);
                setTimeout(function() {
                window.open("https://v2.reservationkey.com/ArrowheadManor/ResCCpmt?_gl=1*1ecm12f*_ga*MTk1NDk1NzAzNy4xNzMwNzQ4ODgx*_ga_EH3N9YS0HN*MTczOTkxMjUxNC4yNS4wLjE3Mzk5MTI1MTQuNjAuMC4xNDcwODA2NjU3*_gcl_au*MTAwNjcxNjc4OS4xNzM5NTY1MzYx*_ga_K2J9GY1QHX*MTczOTkxMjUxNS4yNS4wLjE3Mzk5MTI1MTUuNjAuMC4w", "_blank");
            }, 3000);
            },
            async: false,
            error: function (data) {
